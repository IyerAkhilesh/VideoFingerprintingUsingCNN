...
video_driver = webdriver.Chrome("D:\\Software\\Chromedriver\\chromedriver.exe")

for video_number in range(0,100):
    with open("D:\\DatasetAndCSV\\dataset\\NewerVideoSet.txt") as file:
        counter = 10
        ...
        for line in file:
            ...
            try:
                ...
                if run_time <= 30:
                    ...
                    p = subprocess.Popen(["powershell.exe","D:\\DatasetAndCSV\\run_tshark.ps1 " + file_name+".txt"],
                                         stdout=sys.stdout)
